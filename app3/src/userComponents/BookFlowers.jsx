            ...
            <div className='mb-6'>
              <div className='flex flex-col space-y-4'>
                <div className="flex items-center">
                  <input id="orchids" type="checkbox" className="form-checkbox h-5 w-5 text-blue-600" onChange={handleFlower} value="on" checked={flower === "on"} />
                  <label htmlFor="orchids" className="ml-2 text-gray-700">Orchids</label>
                </div>
                <div className="flex items-center">
                  <input id="redflower" type="checkbox" className="form-checkbox h-5 w-5 text-blue-600" onChange={handleFlower} value="off" checked={flower === "off"} />
