    ...
    <>
      <div className='flex flex-col justify-center items-center md:px-4'>
        ...
        <div className='flex flex-wrap justify-around gap-8 md:gap-20 mt-8'>
          <div id="over-card1" className="over-card border-2 border-black text-black h-[200px] w-[200px] text-center rounded-lg shadow-xl cursor-pointer">
            <CiMail className="my-6 w-10 h-10 ml-16" />
            <h2 className="text-xl mb-1">Subscribers</h2>
            <p className='text-xl mt-4'><b>450</b></p>
          </div>
          <div id="over-card2" className="over-card border-2 border-yellow-400 w-[200px] text-center rounded-lg shadow-xl">
            <CiTwitter className="my-6 w-10 h-10 ml-16" />
            <h2 className="text-xl mb-1">Followers</h2>
            <p className='text-xl mt-4'><b>500</b></p>
          </div>
          <div id="over-card3" className="over-card border-2 border-red-500 w-[200px] text-center rounded-lg shadow-xl">
            <IoBagRemoveOutline className="my-6 w-10 h-10 ml-16" />
            <h2 className="text-xl mb-1">Business Plan</h2>
            <p className='text-xl mt-4'>--</p>
          </div>
          <div id="over-card4" className="over-card border-2 border-green-500 w-[200px] text-center rounded-lg shadow-xl">
